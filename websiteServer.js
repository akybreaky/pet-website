...
app.get('/have-a-pet-giveaway', (req, res) => {
    res.render('have-a-pet-giveaway', {
        header: header,
        footer: footer,
        session: req.session
    });
...
app.post('/create-account', (req, res) => {
    ...
    res.send('<script>alert("Account created successfully. You can now fill out the Have a pet to giveaway form"); window.location.href="/have-pet-giveaway";</script>');
});
app.post('/have-a-pet-giveaway', (req, res) => {
